<template>
    <div class="container">
        <div class="head">
            <div>
                <span
                    :class="{ active: !isHelpMode }"
                    @click="isHelpMode = false"
                    >检测页</span
                >
                <span :class="{ active: isHelpMode }" @click="isHelpMode = true"
                    >使用指南</span
                >
                <a
                    href="https://github.com/thegreatjavascript/FakeScreenshot"
                    target="_blanket"
                    >项目主页</a
                >
            </div>
        ...
        <div class="check" v-if="!isHelpMode">
            <header>
                ...
                <p>
                    如果你有看到<strong>Made By Fakescreenshot</strong
                    >水印或部分水印，说明该截图有90%的可能性由本工具生成。<span
                        >剩余10%呢？有被人故意用PS或者Web技术伪造一个相同的水印的可能。</span
                    >
                </p>
                <h3>
                    <span>2. </span>如果没有看到<strong
                        >Made By Fakescreenshot</strong
                    >水印，是不是说明截图不是伪造的？
                </h3>
                <p>
                    <span class="big">大错特错！</span
                    >上述水印只是本工具独有。其他人完全可以通过修改网页源码来自行伪造截图，或利用PS等技术实现伪造效果，却没有水印。
                </p>
                <h3 class="bottom-30">
                    <span>3. </span
                    >本工具会为图片打上肉眼可见的水印，因此无需使用此检测工具测试。
                </h3>
            </header>
            <section>
